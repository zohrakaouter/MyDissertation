...
\item Chapter 2 provides a short background about our MDE context and main concepts concepts that will be employed throughout the thesis.
\item Chapter 3 focuses a review of relevant studies carried out within Metamodel change detection, co-evolution in MDE ecosystem, API-client evolution, language evolution, and evolution in low-code platforms. This chapter with a discussion about limitations and research gap.
...
\item Chapter 5 presents our second contribution about leveraging unit tests to check metamodel and code co-evolution behavioral correctness with its evaluation including the user experience and results.
